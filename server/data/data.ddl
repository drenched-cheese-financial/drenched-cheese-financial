...
INSERT INTO category(categoryName) VALUES ('Vinyls');
INSERT INTO category(categoryName) VALUES ('Cups');
INSERT INTO category(categoryName) VALUES ('Hats');

INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('DCF Logo Shirt 1',1,'The classic DCF logo to impress your friends.',18.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('DCF Logo Shirt 2',1,'The updated DCF logo for the extra cool.',19.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Get Drenched Shirt 1',1,'Get Drenched!',10.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Get Drenched Shirt 2',1,'Ya YEET!',22.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Get Drenched Album Vinyl',2,'In perfect condition.',36.95);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Money with Mold EP Vinyl',2,'The classic EP that started it all.',25.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Money in the DB Album Vinyl',2,'Literally, in the DB.',30.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Drenched Cup 1',3,'Large size mug, for your drenching needs.',40.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Drenched Cup 2',3,'Medium size mug, for your semi-drenching needs.',24.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Drenched Logo Cup',3,'The original. The classic. The beauty.',31.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('DCF Cap',4,'The pinnacle of haute couture.',125.00);
...
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (5, 1, 6, 36.95);
...
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (9, 1, 2, 24);
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (10, 1, 3, 31);
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (11, 1, 3, 125);
...
INSERT INTO customer (firstName, lastName, email, phonenum, address, city, state, postalCode, country, userid, password, isAdmin) VALUES ('Darren', 'Doe', 'oe@doe.com', '250-807-2222', '444 Dover Lane', 'Kelowna', 'BC', 'V1V 2X9', 'Canada', 'darren' , 'pw', 1);
...
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 8, 3, 23.25)
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 9, 2, 21.05)
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 11, 4, 14);

DECLARE @orderId int
INSERT INTO ordersummary (customerId, orderDate, totalAmount) VALUES (5, '2019-10-15 10:25:55', 277.40)
SELECT @orderId = @@IDENTITY
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 5, 4, 21.35)
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 9, 2, 81)
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 10, 3, 10);

-- New SQL DDL for lab 8
UPDATE Product SET productImageURL = 'img/dcf1.png' WHERE ProductId IN (1, 2, 3, 4);
UPDATE Product SET productImageURL = 'img/dcf2.png' WHERE ProductId IN (5, 6, 7);
UPDATE Product SET productImageURL = 'img/dcf3.png' WHERE ProductId IN (8, 9, 10);
UPDATE Product SET productImageURL = 'img/dcf4.png' WHERE ProductId = 11;
